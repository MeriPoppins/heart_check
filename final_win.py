...
class FinalWin(QWidget):
    ...
    def initUI(self):
        ...
        self.result_text = QLabel(txt_index + self.results())
        self.index_text = QLabel(txt_workheart + str(self.index))
        self.layout_line.addWidget(self.result_text, alignment=Qt.AlignCenter)
